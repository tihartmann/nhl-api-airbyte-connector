...
import pytest
from source_nhl_api.source import NhlApiStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(NhlApiStream, "path", "v0/example_endpoint")
    mocker.patch.object(NhlApiStream, "primary_key", "test_primary_key")
    mocker.patch.object(NhlApiStream, "__abstractmethods__", set())
